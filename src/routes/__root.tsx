...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://geochallengedaily.lovable.app/preview-v2.png" },
      { name: "twitter:image", content: "https://geochallengedaily.lovable.app/preview-v2.png" },
    ],
    links: [
      {
        rel: "stylesheet",
